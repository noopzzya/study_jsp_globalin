...
<table align="center" width="500" border="1" cellpadding="0" cellspacing="0" bgcolor="${bodyback_c}">
	...
	<tr height="30">
		<td colspan="4" bgcolor="${value_c}" align="right">
			...
			<input type="button" value="답변글" onclick="document.location.href='/boardtwo/writeForm.bdo?num=${article.num}&ref=${article.ref}&step=${article.step}&depth=${article.depth}'">
			&nbsp;&nbsp;&nbsp;&nbsp;
