...
public class JOptionPaneEx extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == b1) {
			JOptionPane.showMessageDialog(this, "메시지 다이얼로그박스", "메시지", JOptionPane.INFORMATION_MESSAGE);
			...
			JOptionPane.showOptionDialog(this, "옵션다이얼로그", "옵션", JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.INFORMATION_MESSAGE, null, str, str[0]);
		}
