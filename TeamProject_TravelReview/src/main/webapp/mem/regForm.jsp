	...
	<div class="border">
		...
		<div>
			...
			<div class="div1">
				...
				<div class="right">
					<input type="button" value="중복확인" onclick="idCheck(this.form.id.value)" class="b_right">
				</div>
			</div>
			...
			<div class="div1">
				...
				<div class="center">
					<input class="c_input" placeholder="비밀번호를 입력해주세요" type="password" name="pass">
				</div>
				<div class="right">
			...
			<div class="div1">
				...
				<div class="center">
					<input class="c_input" placeholder="비밀번호를 한번 더 입력해주세요" type="password" name="repass">
				</div>
				<div class="right">
					<input type="hidden" class="w_right">
				</div>
			...
			<div class="div1">
				...
				<div class="center">
					<input class="c_input" placeholder="이름을 입력해주세요" type="text" name="name">
				</div>
				<div class="right">
					<input type="hidden" class="w_right">
				</div>
			...
			<div class="div1">
				...
				<div class="center">
					<input class="c_input" placeholder="이메일을 입력해주세요" type="text" name="email">
				</div>
				<div class="right">
					<input type="hidden" class="w_right">
				</div>
			...
			<div class="div1">
				...
				<div class="center">
					<input class="c_input" placeholder="숫자만 입력해주세요" type="text" name="phone">
				</div>
				<div class="right">
					<input type="hidden" class="w_right">
				</div>
			...
			<div class="div1">
				...
				<div class="right">
					<input type="button" value="찾기" onclick="zipCheck()" class="b_right">
				</div>
			</div>
			...
			<div class="div1">
				...
				<div class="center">
					<input class="c_input" placeholder="상세주소를 입력해주세요" type="text" name="address2">
				</div>
				<div class="right">
					<input type="hidden" class="w_right">
				</div>
			...
			<div class="c_bottom">
				<input type="button" value="가입하기" onclick="inputCheck()" class="c_button" >
			</div>
